...
class ext_mangafreak_e2e_test(unittest.TestCase):
    ...
    def test_get_serie_title(self):
        ...
        res = mangafreak.get_serie_title(self.browser, arg)
        self.assertEqual('KNIGHTS OF SIDONIA', res)

    def test_get_chapter_url_list(self):
        arg = "http://w14.mangafreak.net/Manga/Knights_Of_Sidonia"
        res = mangafreak.get_chapter_url_list(self.browser, arg)
    ...
    def test_get_page_url_list(self):
        ...
        res = mangafreak.get_page_url_list(self.browser, arg)
        self.assertTrue(len(res) > 0)
